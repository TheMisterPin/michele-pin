...
import Section from '@/components/organisms/section-container'
import AboutMeGrid from '@/components/organisms/about-me-grid'
...
export default function AboutMeSection() {
  ...
  return (
    <Section id="about">
      <div
        className="container h-[85vh] mx-auto px-4 py-8 flex flex-col"
        ref={ref}
      >
        <motion.h2
